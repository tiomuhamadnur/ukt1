...
class StatusAbsensiDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('aksi', function ($item) {
                $editRoute = route('status-absensi.update', $item->uuid);
                $editButton = "
                ...
                $deleteRoute = route('status-absensi.destroy', $item->uuid);
                $deleteButton = "
    ...
    public function query(StatusAbsensi $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('statusabsensi-table')
    ...
    {
        return 'StatusAbsensi_' . date('YmdHis');
    }
}
