...
class JenisAbsensiDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('aksi', function ($item) {
                $editRoute = route('jenis-absensi.update', $item->uuid);
                $editButton = "
                ...
                $deleteRoute = route('jenis-absensi.destroy', $item->uuid);
                $deleteButton = "
    ...
    public function query(JenisAbsensi $model): QueryBuilder
    {
    ...
    {
        return 'JenisAbsensi_' . date('YmdHis');
    }
}
