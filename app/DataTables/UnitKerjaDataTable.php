...
class UnitKerjaDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('aksi', function ($item) {
                $editRoute = route('unit-kerja.update', $item->uuid);
                $editButton = "
                ...
                $deleteRoute = route('unit-kerja.destroy', $item->uuid);
                $deleteButton = "
    ...
    {
        return [
            Column::make('name')->title('Nama Unit Kerja'),
            Column::make('code')->title('Kode Unit Kerja'),
