...
class RoleController extends Controller
{
    public function index(RoleDataTable $dataTable)
    {
        ...
        return $dataTable->render('page.admin.dataEssentials.role.index', compact([
            'permissions',
        ]));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->withNotify("Role <strong>{$role->name}</strong> berhasil ditambahkan.");
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return back()->withNotify("Role <strong>{$role->name}</strong> berhasil diperbarui.");
    }
    ...
    public function destroy(string $id)
    {
        ...
        return back()->withNotify("Role <strong>{$role->name}</strong> berhasil dihapus.");
    }
}
