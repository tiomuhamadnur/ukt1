                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable">
                            ...
                            <tbody>
                                    ...
                                    <div class="modal fade" id="editData{{ $item->uuid }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('tim.update', $item->uuid) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">Belum ada data Tim.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Konfirmasi Hapus Tim</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                ...
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus data Tim ini?</p>
                    </div>
...
@section('javascript')
    <script>
        function toggleModal(uuid) {
            let url = "{{ route('tim.destroy', ':uuid') }}";
