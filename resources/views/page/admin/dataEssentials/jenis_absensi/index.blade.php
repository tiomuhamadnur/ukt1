...
@section('content')
                ...
                <form action="{{ route('jenis-absensi.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="required">Nama Jenis Absensi:</label>
                            <input type="text" class="form-control" name="name" required>
                        </div>
                        <div class="form-group">
                            <label class="required">Kode Jenis Absensi:</label>
    ...
    <!-- End Modal Tambah Jenis Absensi -->

    <!-- Modal Edit Jenis Absensi -->
