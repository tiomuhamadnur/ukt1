                        ...
                        <table class="table table-bordered table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nama Status Cuti</th>
                                    <th class="text-center">Kode</th>
                                    <th class="text-center">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($status_cuti as $item)
                                    <tr>
                                    ...
                                    <div class="modal fade" id="editData{{ $item->uuid }}" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('status-cuti.update', $item->uuid) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Nama Status Cuti:</label>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">Belum ada data status cuti.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    @method('DELETE')
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus data status cuti ini?</p>
                    </div>
...
@section('javascript')
    <script>
        function toggleModal(uuid) {
            let url = "{{ route('status-cuti.destroy', ':uuid') }}";
