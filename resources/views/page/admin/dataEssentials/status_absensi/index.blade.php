                        ...
                        <table class="table table-bordered table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nama Status Absensi</th>
                                    <th class="text-center">Kode</th>
                                    <th class="text-center">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($status_absensi as $item)
                                    <tr>
                                    ...
                                    <div class="modal fade" id="editData{{ $item->uuid }}" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('status-absensi.update', $item->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">Belum ada data status absensi.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    @method('DELETE')
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus data status absensi ini?</p>
                    </div>
...
@section('javascript')
    <script>
        function toggleModal(uuid) {
            let url = "{{ route('status-absensi.destroy', ':uuid') }}";
