...
@section('content')
                            ...
                            <tbody>
                                @forelse ($kelurahan as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $item->kecamatan->name ?? '-' }}</td>
                                    ...
                                    <div class="modal fade" id="editData{{ $item->uuid }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('kelurahan.update', $item->uuid) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="kecamatan_id" class="form-control" required>
                                                                <option value="" disabled>-- Pilih Kecamatan --
                                                                </option>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">Belum ada data kelurahan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <!-- Modal Hapus Kelurahan -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title">Konfirmasi Hapus Kelurahan</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                ...
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin menghapus data kelurahan ini?</p>
                    </div>
...
@section('javascript')
    <script>
        function toggleModal(uuid) {
            let url = "{{ route('kelurahan.destroy', ':uuid') }}";
