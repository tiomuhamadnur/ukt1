...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Konfigurasi Cuti Tahun #</li>
        </ol>
    </div>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            ...
                            <a href="javascript:;" class="btn btn-primary" data-toggle="modal" data-target="#modalFilter"
        ...
        <div class="modal fade" id="modalFilter" tabindex="-1" role="dialog" aria-labelledby="modalFilter"
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFilter" action="{{ route('konfigurasi-cuti.index') }}" method="GET">
                            @csrf
                            @method('GET')
