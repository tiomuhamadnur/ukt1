...
<head>
    ...
    <title>Sigma Notification System</title>
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <a href="{{ route('dashboard.index') }}" class="logo">
                                    <img src="{{ asset('assets/img/sigmalogo.png') }}" alt="Sigma Logo"
                        ...
                        <tr>
                            <td class="wrapper">
                                ...
                                <p>Personil lapangan atas nama <span class="fw-bolder">{{ $mailData['nama'] }}</span>
                                    telah mengajukan cuti melalui <span class="fw-bolder">SIGMA</span>.</p>
                                ...
                                <p>Salam,</p>
                                <p class="fw-bolder italic underline">SIGMA Notification System</p>
                            </td>
                        </tr>
