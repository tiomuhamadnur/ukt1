...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Absensi Seksi {{ auth()->user()->seksi->name ?? 'N/A' }}</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Rekap
                        Absensi - Seksi {{ auth()->user()->seksi->name ?? 'N/A' }}</h4>
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                <a href="{{ route('kasi.index') }}" class="btn btn-outline-primary mr-2 mb-2 mb-sm-0"><i
                                ...
                                <a href="{{ route('kasi-absensi.index') }}" class="btn btn-primary mr-2 mb-2 mb-sm-0"><i
