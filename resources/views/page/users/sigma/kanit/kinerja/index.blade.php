...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Kinerja {{ auth()->user()->unit_kerja->name ?? 'N/A' }}</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Rekap
                        Kinerja - {{ auth()->user()->unit_kerja->name ?? 'N/A' }}</h4>
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                ...
                                <a href="{{ route('kanit-kinerja.index') }}" title="Reset Filter" class="btn btn-primary mr-2 mb-2 mb-sm-0"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formFilter" action="{{ route('kanit-kinerja.index') }}" method="GET">
                        @csrf
                        @method('GET')
                                    ...
                                    <select name="kegiatan_id" class="form-control">
                                        ...
                                        @foreach ($kegiatan as $item)
                                            <option value="{{ $item->id }}" @selected($item->id == $kegiatan_id)>
                                                (Seksi {{ $item->seksi->name ?? 'N/A' }}) - {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
