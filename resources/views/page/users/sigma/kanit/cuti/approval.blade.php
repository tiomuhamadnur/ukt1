            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Daftar
                        Persetujuan Pengajuan Cuti - {{ auth()->user()->unit_kerja->name ?? 'N/A' }}</h4>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                <a href="{{ route('kanit.index') }}"
                                    ...
                                    Kembali</a>
                                <a href="{{ route('kanit-cuti-approval.index') }}" title="Reset Filter" class="btn btn-primary mr-2 mb-2 mb-sm-0"><i
